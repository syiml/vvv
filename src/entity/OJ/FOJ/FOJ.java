...
public class FOJ extends OTHOJ{
    ...
    public problemHTML getProblemHTML(String pid) {
        ...
        pHTML.addSample(d.select(".data").get(0).html(),d.select(".data").get(1).html());
    ...
    public String submit(VjSubmitter s) {
        ...
        login_para.add(new BasicNameValuePair("act","5"));
        login_para.add(new BasicNameValuePair("dir","L3N1Ym1pdC5waHA/cGlkPSZhY3Q9MQ=="));
        login_para.add(new BasicNameValuePair("uname",s.getUsername()));
        login_para.add(new BasicNameValuePair("upassword",s.getPassword()));
        client.Post(URL+"/login.php",login_para);

        int lang = 0;
        List<NameValuePair> para = new ArrayList<>();
        para.add(new BasicNameValuePair("act","5"));
    ...
    public RES getResult(VjSubmitter s) {
        ...
        if(e == null) {
            ...
            res.setTime(e.get(5).text().replace(" ",""));
